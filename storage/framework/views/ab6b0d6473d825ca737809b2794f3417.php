<div class="bg-white dark:bg-gray-700 rounded-lg shadow overflow-hidden">
        ...
        <?php if(isset($work->media) && count($work->media) > 0): ?>
            ...
            <?php elseif(isset($firstMedia['type']) && str_contains($firstMedia['type'], 'video')): ?>
                <div class="relative w-full h-full">
                    <img src="<?php echo e(asset('images/video-placeholder.jpg')); ?>" class="w-full h-full object-cover">
    ...
    <div class="p-4">
        <h3 class="text-lg font-semibold mb-2 text-gray-900 dark:text-gray-100"><?php echo e($work->title); ?></h3>
        ...
        <div class="flex justify-end">
            <button type="button" class="text-blue-600 dark:text-blue-400 hover:underline" onclick="showWorkDetails('<?php echo e($work->id); ?>', '<?php echo e($work->title); ?>', '<?php echo e($work->description); ?>', '<?php echo e($work->completion_date->format('Y-m-d')); ?>')">
...
<?php if (! $__env->hasRenderedOnce('10dd48e5-c5b5-4574-ac92-bc0d92eef0cb')): $__env->markAsRenderedOnce('10dd48e5-c5b5-4574-ac92-bc0d92eef0cb'); ?>
<div id="workDetailsModal" class="fixed inset-0 z-50 flex items-center justify-center hidden">
    ...
    <div class="relative bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="mb-4">
            <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1"><?php echo e(__('تاريخ الإنجاز')); ?></h4>
            <p id="modalDate" class="text-gray-900 dark:text-gray-100"></p>
        </div>
        
        <div class="mb-4">
            <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1"><?php echo e(__('وصف العمل')); ?></h4>
...
<?php endif; ?> <?php /**PATH C:\laragon\www\hirafi\resources\views/craftsman/portfolio/partials/work-card.blade.php ENDPATH**/ ?>