...
<?php endif; ?>
    ...
    <div class="mt-6 text-center">
        <p class="text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__('هل أنت حرفي؟')); ?>

            <a href="<?php echo e(route('craftsman.register')); ?>" class="font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\hirafi\resources\views/auth/login.blade.php ENDPATH**/ ?>