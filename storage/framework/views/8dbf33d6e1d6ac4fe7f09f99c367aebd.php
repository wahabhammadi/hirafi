...
<body>
    <div class="container">
        ...
        <div class="footer">
            ...
            <p>&copy; <?php echo e(date('Y')); ?> موقع حرفي. جميع الحقوق محفوظة.</p>
        </div>
    </div>
</body>
</html> <?php /**PATH C:\laragon\www\hirafi\resources\views/emails/verification-code.blade.php ENDPATH**/ ?>